...
const Search = () => {
  ...
  return (
    <View style={styles.container}>
      <View style={{height:90,width:'100%',justifyContent:'flex-end',backgroundColor:'#fff',borderColor:'#e5e5e5',paddingBottom:10,borderBottomWidth:1}}>
        <View style={{height:30,width:'95%',alignSelf:'center',paddingHorizontal:10,paddingVertical:5,borderRadius:5,flexDirection:'row', backgroundColor:'#E5E5E5', alignItems:'center'}}>
        <Ionicons name='search-outline'size={20}/>
        <TextInput onChangeText={text=>setText(text)} style={{fontSize:18,paddingLeft:6,flex:1}} placeholder="Search"/>
